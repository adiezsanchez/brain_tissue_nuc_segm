...
| <img src="https://img.youtube.com/vi/VIDEO_ID_4/0.jpg" width="240"> | [Part 4.1 - Defining Marker Positive Cells - Average Intensity](https://www.youtube.com/watch?v=VIDEO_ID_4) | Method 1: Define positive cells for a marker based on the **average intensity** of each marker within the nucleus, the cytoplasm or the whole cell. A cell is considered **positive** if the average intensity falls within the **user-defined min and max thresholds**. Choose **`000_SP_Avg_Intensity.ipynb`** & **`003_BP_Avg_Intensity.ipynb`**. |
